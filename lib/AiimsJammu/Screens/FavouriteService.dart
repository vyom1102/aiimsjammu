  ...
  Future<void> updateUserFavorites(String id,int index) async {
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        doctorLocations.removeAt(index);
        doctorSpeciality.removeAt(index);
        FserviceId.removeAt(index);
        doctorLocationId.removeAt(index);
        favoriteStates.removeAt(index);
      });
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () async {
                                          ...
                                          await updateUserFavorites(FserviceId[index],index);
                                        },
                                        icon: Icon(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: OutlinedButton(
                                          onPressed: () {
                                            _shareContent("${AppConfig.baseUrl}/#/iway-apps/aiimsj.com/service?serviceId=${FserviceId[index]}&appStore=com.apollo.hyderabad&playStore=com.apollo.hyderabad");
