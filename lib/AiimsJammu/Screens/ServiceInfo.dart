          ...
          children: [
            ...
            Expanded(
              child: OutlinedButton(
                onPressed: () {
                  _shareContent("${AppConfig.baseUrl}/#/iway-apps/aiimsj.com/service?serviceId=${widget.id}&appStore=aiims-jammu-navigation/id6677034083&playStore=com.iwayplus.aig");
