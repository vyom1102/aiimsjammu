...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
    ...
    if (newPassword != confirmPassword) {
      ...
      return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: TranslatorWidget('Error'),
            content: TranslatorWidget('New Password and Confirm Password do not match.'),
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
                },
                child: TranslatorWidget('OK'),
              ),
            ],
          );
        },
  ...
  void _showSuccessAlert() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: TranslatorWidget('Success'),
          content: TranslatorWidget('Password updated successfully.'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
  ...
  void _showErrorAlert() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: TranslatorWidget('Error'),
          content: TranslatorWidget('Failed to update password. Please try again later.'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
