                              ...
                              TranslatorWidget(
                                      ...
                                      IconButton(
                                        onPressed: () async {
                                          ...
                                          await updateUserFavorites(FdoctorId[index],index);
                                        },
                                        icon: Icon(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: OutlinedButton(
                                          onPressed: () {
                                            _shareContent("${AppConfig.baseUrl}/#/iway-apps/aiimsj.com/doctor?docId=${FdoctorId[index]}&appStore=com.apollo.hyderabad&playStore=com.apollo.hyderabad");
