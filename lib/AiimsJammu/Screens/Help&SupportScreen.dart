          ...
          Semantics(
            ...
            child: InkWell(
              onTap: () {
                ...
                _launchURL('https://play.google.com/store/apps/details?id=com.apollo.hyderabad');
              },
              child: Container(
                width: MediaQuery.sizeOf(context).width,
                height: 50,
          ...
          Semantics(
            ...
            child: InkWell(
              onTap: (){
                ...
                // _shareContent("https://play.google.com/store/apps/details?id=com.apollo.hyderabad");
