      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: (){
            _shareContent("${AppConfig.baseUrl}/#/iway-apps/aiimsj.com/doctor?docId=${widget.docId}&appStore=aiims-jammu-navigation/id6677034083&playStore=com.iwayplus.aiimsjammu");
