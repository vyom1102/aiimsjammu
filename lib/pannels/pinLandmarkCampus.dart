...
class pinLandmarkCampus extends StatefulWidget {
  ...
  @override
  _pinLandmarkCampusState createState() => _pinLandmarkCampusState();
}

class _pinLandmarkCampusState extends State<pinLandmarkCampus> {
  ...
  @override
  void didUpdateWidget(covariant pinLandmarkCampus oldWidget) {
                          ...
                          return Container(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: marker.markerId.value.split('#')[1].isEmpty?Column(
