...
class NavigationLog {
  ...
  final bool directionButton;
  // final bool abruptEnd;
  DateTime? endTime;
  bool isSuccess;
  ...
  factory NavigationLog.fromJson(Map<String, dynamic> json) {
    return NavigationLog(
      ...
      reason: json["reason"],
      rerouteCount: json["rerouteCount"], directionButton: json["directionButton"],
      // abruptEnd: json["abruptEnd"],
    );
  }
}
